...
TEXT = {
    'hello': 'Привет!/Здравствуйте/Прив',
    ...
    'back': 'Ты находишься в меню, откроем ?/ТЫ в меню, откроем списо',
...
HELP = {
    State.MENU: 'Скажите "Список желаний", чтобы посмотреть все желания. Скажите "Мои желания",'
                ' чтобы посмотреть ваши желания.',
    State.USERS_LIST: 'Скажите "Далее", чтобы посмотреть следующее желание. Скажите "Назад", чтобы '
                      'посмотреть предыдущее желание ',
    State.OTHERS_LIST: 'Скажите "Дальше", чтобы прослушать все теги и выберите, что вам нравится или скажите "Все"',
...
BUTTONS = {
    ...
    State.OTHERS_LIST: ('Далее', 'Помощь'),
